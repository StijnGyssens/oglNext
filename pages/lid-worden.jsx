...
import style from "../styles/lid-worden.module.scss";
    ...
    <Layout>
      ...
      <section className={style.small}>
        ...
        <p>
          ...
          stemgerechtigd en dient u ook de reden van uw kandidaat-lidmaatschap
          op te geven.
        </p>
      </section>
      <section className={style.small}>
      ...
      <section className={style.small}>
        ...
        <ul>
          ...
          <li>
            U krijgt op regelmatige basis updates omtrent alles wat ondernemen
            in Londerzeel aanbelangt
          </li>
          <li>U wordt op de hoogte gehouden van de Londerzeelse actualiteit</li>
          <li>
            U krijgt toegang tot een uitgebreid netwerk van regionale
            ondernemers
          </li>
          <li>
      ...
      <section className={style.small}>
        ...
        <p>
          ...
          onderstaande link.
          <br />
          Na behandeling van uw aanvraag krijgt u een factuur doorgestuurd, die
          u liefst zo snel mogelijk voldoet...
          <br />
